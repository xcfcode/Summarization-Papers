...
1. **Structure-Aware Abstractive Conversation Summarization via Discourse and Action Graphs** *Jiaao Chen, Diyi Yang* `NAACL21` [[pdf]](https://www.cc.gatech.edu/~dyang888/docs/naacl21_chen_summarization.pdf) [[code]](https://github.com/GT-SALT/Structure-Aware-BART) ![](https://img.shields.io/badge/-samsum-orange)
